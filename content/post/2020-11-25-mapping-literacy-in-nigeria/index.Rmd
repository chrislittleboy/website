...
much higher level of education than is often implied. Her argument, in
short, was that public provision of primary education in Nigeria has a
...
downloaded the microdata of the latest Multiple Indicator Cluster Survey
(MICS) for Nigeria collected in 2016/17 https://microdata.worldbank.org/index.php/catalog/3002/study-description. This contains the data of rural
and urban areas of each of the 36 states in Nigeria. The questionnaire
...
So, I downloaded the data, selected the right variables (literacy, age,
gender), weighted the responses according to the survey sampling
procedure, aggregated literacy rates at the state level, downloaded a
map for Nigeria (<https://gadm.org/>), and created this interactive map
largely following a procedure found here
(<https://rpubs.com/castower/choroplethmap>).
